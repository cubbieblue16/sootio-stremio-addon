...
// NO-OP PLACEHOLDER: applyPornFilter is not yet implemented.
// It passes through the list unchanged until isPornTitle is added to torrent-utils.js.
function applyPornFilter(list) {
  if (!Array.isArray(list)) return [];
  console.debug('[scrapers-filtered] applyPornFilter called (no-op placeholder) - list passed through unchanged');
  return list;
}
